...
class DataView(PermissionRequiredMixin, DetailView):
    pass
...
class DataAddition(PermissionRequiredMixin):
        permission_required = 'SCControlSystem.classroom_action_log_viewable'
    pass

class DataDeletion(PermissionRequiredMixin):
        permission_required = 'SCControlSystem.classroom_action_log_viewable'
    pass

class DataUpdate(PermissionRequiredMixin):
        permission_required = 'SCControlSystem.classroom_action_log_viewable'
    pass
